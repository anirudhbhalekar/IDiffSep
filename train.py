...
def main(cfg):
    ...
    wandb.init(project="diffusion-separation", sync_tensorboard=True, name="DiffSep S1-S2 CONT.")
    tb_logger = pl_loggers.TensorBoardLogger(save_dir="/research/milsrg1/user_workspace/ab2810/IIB_Proj/diffusion-separation/tensorboard_sessions", name="MOD_RUN_CONT")
