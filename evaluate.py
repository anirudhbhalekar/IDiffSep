...
if __name__ == "__main__":
    ...
    if no_proc_flag:
        ...
        with open("/research/milsrg1/user_workspace/ab2810/IIB_Proj/diffusion-separation/tensorboard_sessions/MOD_RUN_CONT/version_1/hparams.yaml") as f:
            hparams = yaml.safe_load(f)
        config = hparams["config"]
        print("Loaded config file")
        print(config)
        print("-"*80)
        print(config["datamodule"]["test"]["dataset"])
        print("-"*80)
        datasets = dict()
        if args.enhance:
        ...
        # load validation dataset
            ...
            for split in ["libri-clean", "libri-noisy", "librimix_dev"]:
            ...
            datasets["libri-clean"] = WSJ0_mix(**config["datamodule"]["librimix_dev"]["dataset"])
